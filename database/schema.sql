...
U.ACTIVADO, U.PASSWORD, A.FEC_ULTIMA_CONEX FROM USUARIO U, ADMINISTRADOR A WHERE U.ID_USUARIO=A.ID_ADMINISTRADOR;

DROP VIEW IF EXISTS VISTA_REGISTRADO;
CREATE VIEW VISTA_REGISTRADO AS SELECT R.ID_REGISTRADO, U.NOMBRE, U.APELLIDO, U.EMAIL, 
U.ACTIVADO, U.PASSWORD, R.NICK FROM USUARIO U, REGISTRADO R WHERE U.ID_USUARIO=R.ID_REGISTRADO;
